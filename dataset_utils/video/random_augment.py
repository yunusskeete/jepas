"""
This file is taken from https://github.com/huggingface/pytorch-image-models/blob/main/timm/data/auto_augment.py pulished under an Apache License 2.0.
"""
...
def rand_augment_transform(
    ...
    ra_ops = rand_augment_ops(
        magnitude=magnitude, prob=prob, hparams=hparams, transforms=transforms
    )
