...
from .random_erasing import RandomErasing  # Apache License 2.0
from .utils import (  # Non-commercial license
...
class VideoTransform(object):
    ...
    def __init__(
        ...
        self.autoaug_transform = create_random_augment(
    ...
    def __call__(self, buffer):
        ...
        if self.random_horizontal_flip:
            buffer, _ = horizontal_flip(0.5, buffer)
